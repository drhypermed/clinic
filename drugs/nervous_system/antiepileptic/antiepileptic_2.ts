...
export const ANTIEPILEPTIC_2: Medication[] = [
	...
	// 70) trileptal 150mg 50 f.c.tab.
	{
		...
		minWeight: 20,
		maxWeight: 250,
		calculationRule: fixed('ابدأ ٣٠٠ مجم/يوم مقسمة على جرعتين لمدة أسبوع، ثم ٦٠٠ مجم/يوم'),
	...
	// 75) conventin 600 mg 30 tabs.
	{
		...
		minWeight: 20,
		maxWeight: 250,
		calculationRule: fixed('٣٠٠–٦٠٠ مجم كل ٨ ساعات. مع تركيز ٦٠٠ مجم: قرص واحد كل ٨ ساعات = ١٨٠٠ مجم/يوم'),
	...
	// 95) mazemal 200 mg 20 tabs.
	{
		...
		minWeight: 20,
		maxWeight: 250,
		calculationRule: fixed('ابدأ ٢٠٠ مجم مرتين يومياً. يمكن زيادة ٢٠٠ مجم/يوم أسبوعياً حتى ٤٠٠ مجم مرتين يومياً. الجرعة المعتادة: ٨٠٠–١٢٠٠ مجم/يوم'),
		warnings: ['قد يسبب دوخة/نعاس.', 'قد يتداخل مع أدوية كثيرة.'],
	},
	...
	// 98) lacosamet 50mg/5ml syrup 200 ml
	{
		...
		minWeight: 15,
		maxWeight: 250,
		calculationRule: fixed('جرعة الكبار: ابدأ ٥٠ مجم كل ١٢ ساعة لمدة أسبوع ثم ١٠٠ مجم كل ١٢ ساعة. يمكن الزيادة تدريجياً حتى ٢٠٠ مجم كل ١٢ ساعة'),
		warnings: ['قد يسبب دوخة/عدم اتزان.', 'يُستخدم بحذر مع اضطرابات التوصيل القلبي.'],
	},
	...
	// 100) andovimpamide 200 mg i.v. inf. vial
	{
		...
		minWeight: 15,
		maxWeight: 250,
		calculationRule: fixed('وريدياً كل ١٢ ساعة لمدة أسبوع ثم ١٠٠ مجم كل ١٢ ساعة. يمكن الزيادة تدريجياً حتى ٢٠٠ مجم كل ١٢ ساعة'),
	...
	// 101) andovimpamide 200mg 10 tabs.
	{
		...
		minWeight: 15,
		maxWeight: 250,
		calculationRule: fixed('قرص واحد كل ١٢ ساعة'),
		warnings: ['قد يسبب دوخة/عدم اتزان.', 'يُستخدم بحذر مع اضطرابات التوصيل القلبي.'],
	},
	...
	// 102) convagran 50 mg 30 caps.
	{
		...
		minWeight: 20,
		maxWeight: 250,
		calculationRule: fixed('ابدأ ٥٠ مجم مرة يومياً لمدة أسبوعين، ثم ١٠٠ مجم/يوم. يمكن زيادة ١٠٠ مجم كل أسبوعين حتى ٢٠٠–٤٠٠ مجم/يوم'),
	...
	// 105) delpiramate 100mg 30 f.c. tab.
	{
		...
		minWeight: 20,
		maxWeight: 250,
		calculationRule: fixed('الجرعة الشائعة بعد التدرج: ٥٠–١٠٠ مجم مرتين يومياً. ابدأ ٢٥ مجم ليلاً ثم زِد تدريجياً ٢٥–٥٠ مجم/الأسبوع'),
		warnings: ['قد يسبب بطء تركيز/تنميل.', 'قد يزيد خطر حصوات الكلى.'],
	},
	...
	// 106) eslizepine 400 mg 20 tabs.
	{
		...
		minWeight: 50,
		maxWeight: 250,
		calculationRule: fixed('٤٠٠ مجم مرة يومياً لمدة ١–٢ أسبوع، ثم ٨٠٠ مجم مرة يومياً. يمكن الزيادة حتى ١٢٠٠–١٦٠٠ مجم مرة يومياً حسب التحمل'),
	...
	// 107) eslizepine 800mg 20 scored tabs.
	{
		...
		minWeight: 50,
		maxWeight: 250,
		calculationRule: fixed('٨٠٠ مجم مرة يومياً. يمكن الزيادة حتى ١٢٠٠–١٦٠٠ مجم مرة يومياً حسب التحمل'),
		warnings: ['قد يسبب دوخة/نعاس.', 'قد يسبب نقص صوديوم الدم.', 'قد يتداخل مع أدوية أخرى.'],
	},
	...
	// 108) ethoxa 250 mg 50 caps.
	{
		...
		minWeight: 10,
		maxWeight: 250,
		calculationRule: fixed('ابدأ ١٠ مجم/كجم/يوم تُقسم على جرعتين، ثم ٢٠ مجم/كجم/يوم'),
		warnings: ['قد يسبب غثيان/ألم معدة.', 'قد يسبب نعاس/دوخة.', 'اطلب رعاية عند طفح جلدي شديد أو كدمات/نزيف غير معتاد.'],
	},
