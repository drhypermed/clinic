...
const CLINIC_LANDING_META = {
  ...
  description: 'نظام متكامل لإداره العياده: روشته إلكترونيّه احترافيّه، أكتر من 5500 دواء بأسعارهم وجرعاتهم وتفاعلاتهم، حجز مواعيد أون لاين، سكرتاريه مربوطه، ملفات مرضى، تقارير ماليّه، وإداره فروع — كل ده في مكان واحد.',
  robots: 'index, follow',
} as const;
