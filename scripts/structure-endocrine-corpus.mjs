...
const sourceRoot = path.resolve('guidelines-sources/Endocrine/extracted');
const structuredRoot = path.resolve('guidelines-sources/_structured/full-text/Endocrine');
const extractedRoot = path.resolve('guidelines-sources/_extracted/full-text/Endocrine');
...
const main = () => {
  ...
  console.log(`Found ${files.length} Endocrine Society guideline text files.`);
  ...
  for (const file of files) {
    ...
    const sourceRelative = `Endocrine/${pdfName}`;
  ...
  console.log(`Successfully structured and extracted all ${totalProcessed} Endocrine Society guideline documents.`);
};
