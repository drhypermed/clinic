...
- Name: login.spec.ts >> Login entry >> shows doctor login button with Google
...
- generic [active] [ref=e1]:
  - status "جاري تشغيل التطبيق" [ref=e2]:
    - img "Dr Hyper Med" [ref=e7]
    - generic [ref=e8]: دكتور هايبر
    - generic [ref=e9]: نظام إدارة العيادات الذكية
    - generic [ref=e10]: جارٍ التحقق من صلاحيات الحساب
  - generic [ref=e15]:
    - generic [ref=e16]:
      - generic [ref=e17]: ثبت التطبيق على الموبايل
      - generic [ref=e18]: التطبيق هيسهّل الوصول من الشاشة الرئيسية ويشتغل كتطبيق مستقل.
      - generic [ref=e19]: لو زر التثبيت مش ظاهر، افتح قائمة المتصفح واختر إضافة إلى الشاشة الرئيسية (Add to Home Screen).
      - generic [ref=e20]:
        - button "إخفاء مطلقًا" [ref=e21] [cursor=pointer]
        - button "إخفاء الآن" [ref=e22] [cursor=pointer]
    - status:
      - generic:
        - img
