...
export const NAV_GROUPS: readonly NavGroup[] = [
  ...
  },
  {
    ...
    emoji: '⚙️',
    items: [
      // أدوات التوسع — للأدمن فقط، فيها زرار إعادة حساب الإحصائيات/ملخصات
      // المرضى ومفاتيح تشغيل المراحل الـ3 من خطة التوسع.
      { id: 'scaleTools', label: 'أدوات التوسع', icon: 'settings' },
      // حزم التخصصات — مفتاح مركزي لتفعيل/تعطيل ميزات خاصه بتخصصات معينه (نسا، رمد...).
      // كل باكدج بيظهر تلقائياً للأطباء اللي تخصصهم مطابق + الأدمن مفعّله.
      { id: 'specialtyPacks', label: 'حزم التخصصات', icon: 'settings' },
