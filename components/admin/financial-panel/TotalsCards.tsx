  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-gradient-to-br from-green-600 to-emerald-700 rounded-xl p-6 shadow-lg">
        ...
        <p className="text-green-100 text-sm mt-2">للعام {selectedYear}</p>
      </div>
      ...
      <div className="bg-gradient-to-br from-red-600 to-rose-700 rounded-xl p-6 shadow-lg">
        ...
        <p className="text-red-100 text-sm mt-2">للعام {selectedYear}</p>
      </div>

      <div
        className={`bg-gradient-to-br ${
          totals.netProfit >= 0 ? 'from-blue-600 to-indigo-700' : 'from-gray-600 to-gray-700'
      ...
      >
        ...
        <p className="text-blue-100 text-sm mt-2">{totals.netProfit >= 0 ? 'ربح' : 'خسارة'}</p>
      </div>
    </div>
  );
};
