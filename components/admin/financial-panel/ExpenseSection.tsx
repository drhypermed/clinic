...
export const ExpenseSection: React.FC<ExpenseSectionProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 border-t-4 border-slate-400">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white text-slate-800 rounded-lg border border-slate-200 focus:border-brand-400 focus:outline-none focus:ring-1 focus:ring-brand-100"
          />
        </div>
        ...
        <div className="flex items-end">
          <button
            ...
            className="w-full px-4 py-2.5 bg-gradient-to-r from-success-600 to-brand-600 hover:from-success-700 hover:to-brand-700 text-white font-bold rounded-lg shadow-sm transition"
          >
            حفظ المصروف
          </button>
        </div>
