...
export const ExternalNotificationBroadcastPanel: React.FC<ExternalNotificationBroadcastPanelProps> = ({
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <div className="bg-slate-700 rounded-2xl shadow-xl p-5 sm:p-6 border-t-4 border-fuchsia-400 dh-stagger-1">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-500 bg-slate-800 text-white px-3 py-2 focus:outline-none focus:ring-2 focus:ring-fuchsia-400"
            />
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-fuchsia-500 hover:bg-fuchsia-600 disabled:opacity-60 disabled:cursor-not-allowed text-white font-black"
            >
