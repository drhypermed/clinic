        ...
        <div className={`relative w-full max-w-md mt-2 mb-4 rounded-2xl border-2 px-4 py-3 overflow-hidden ${cardBg}`}>
            ...
            <div className="relative flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                    ...
                    {/* علامة صح زرقاء للحسابات المدفوعة النشطة (برو أو برو ماكس) — تأكيد التفعيل */}
                    {isPaid && !isProExpired && (
                        /* علامة "مفعّل" — أزرق موحّد في كل التطبيق جنب برو/برو ماكس */
                        <span
                            className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-500 text-white shadow-sm ring-1 ring-blue-300"
                            aria-label="مفعّل"
                            title="مفعّل"
                        >
            ...
            {isPaid ? (
                <div className="relative mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2 text-right">
                    {/* بطاقات تاريخ — خلفية بيضاء صلبة (مش شفافة) عشان النص يبان واضح */}
                    <div className="rounded-xl bg-white border border-white shadow-sm px-3 py-2">
                ...
                <div className="relative mt-3 space-y-2 text-right">
                    ...
                    {isProExpired && (
                        /* تنبيه انتهاء الاشتراك — amber دلالي (warning) — استثناء مقبول */
                        <div className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2">
                            ...
                            <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
                                ...
                                {/* زر "تواصل واتساب" — أخضر متدرج فقط (emerald، يطابق branding واتساب) */}
                                <button
                                    type="button"
                                    onClick={onContactRenewalWhatsApp}
                                    className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-l from-emerald-700 to-emerald-500 px-3 py-1.5 text-xs font-black text-white hover:from-emerald-800 hover:to-emerald-600 shadow-[0_2px_8px_-1px_rgba(5,150,105,0.4)] transition-all"
                                >
