...
export const GINA_2025_GENERAL_PRINCIPLES_TOPICS: GuidelineTopic[] = [
  {
    ...
    summary: {
      ...
      ar: 'كل مريض ربو يجب أن يحصل على علاج يحتوي على كورتيزون مستنشق (ICS). لا توصي GINA بعلاج الربو بـ SABA وحده.',
    },
    points: {
      en: [
      ...
      ar: [
        ...
        'جرعة منخفضة من ICS-formoterol هي المسكن المُفضل للبالغين والمراهقين بدلاً من SABA.',
        'العلاج بـ SABA وحده يرتبط بزيادة التهاب الشعب الهوائية، ضعف الاستجابة لموسع الشعب، وزيادة خطر الوفاة بسبب الربو.',
        'صرف 3 بخاخات SABA أو أكثر سنوياً يرتبط بزيادة خطر الانتكاسات الشديدة، وصرف 12 بخاخة أو أكثر سنوياً يرتبط بزيادة خطر الوفاة بسبب الربو.',
      ],
    },
    quickDecision: {
      warn: {
        en: 'For safety, GINA recommends that asthma should not be treated solely with as-needed SABA.',
        ar: 'لأجل سلامة المريض، لا توصي GINA بعلاج الربو بـ SABA عند اللزوم وحده.',
      }
    },
  ...
  },
  {
    ...
    points: {
      ...
      ar: [
        ...
        'اكتشف سبب عدم الالتزام: التكلفة، الخوف من الأعراض الجانبية، النسيان، سوء الفهم، أو الاعتقاد أن الدواء غير ضروري.',
      ],
    },
    sourceIds: ['gina-2025-general'],
