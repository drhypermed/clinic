  ...
  },
  {
    ...
    points: {
      ...
      ar: [
        ...
        'الفجوة الرقمية (Digital Divide): يُحذر الدليل الاستشاريين من الاعتماد الأعمى على التكنولوجيا دون تقييم قدرة المريض على الوصول للإنترنت أو امتلاك أجهزة ذكية.'
      ]
    }
  },
  {
  ...
  },
  {
    ...
    points: {
      en: [
        ...
        'Consultant Takeaway: Management no longer relies solely on prescribing the latest drugs; it demands a comprehensive evaluation of cost, housing, and food barriers within a multidisciplinary team.'
      ],
      ar: [
        ...
        'الخلاصة للاستشاريين: النجاح في الإدارة لم يعد يعتمد فقط على أحدث الأدوية، بل يتطلب تقييماً شاملاً للمريض. التدخل الناجح يجمع بين التوصيات الدقيقة، والدعم لتخطي حواجز التكلفة والسكن.'
      ]
    }
  }
];