...
export const NotificationPermissionPrompt: React.FC<NotificationPermissionPromptProps> = ({
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[10020] w-[min(94vw,33rem)]" dir="rtl">
      <div className="rounded-2xl border border-brand-200 bg-white shadow-[0_24px_50px_-28px_rgba(2,6,23,0.8)] p-4 sm:p-5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-3 flex items-center justify-end gap-2 flex-wrap">
              ...
              <button
                type="button"
                onClick={onEnable}
                className="px-3 py-2 rounded-xl bg-brand-600 text-white text-xs sm:text-sm font-black hover:bg-brand-700 transition-colors"
              >
                {enableLabel}
              </button>
            </div>
