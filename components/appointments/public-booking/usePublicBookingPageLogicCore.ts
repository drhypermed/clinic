...
export const usePublicBookingPageLogic = () => {
  ...
  const appointmentActions = usePublicBookingAppointmentActions({
    ...
    secretaryName: auth.secretaryNameInput,
    ...
    visitServiceDrafts: state.visitServiceDrafts,
    ...
    setVisitServiceDrafts: state.setVisitServiceDrafts,
    setPendingEntryAppointmentId: state.setPendingEntryAppointmentId,
  ...
  return {
    ...
    publicFormTitle: publicSection.publicFormTitle,
    setPublicFormTitle: publicSection.setPublicFormTitle,
    publicFormContactInfo: publicSection.publicFormContactInfo,
    setPublicFormContactInfo: publicSection.setPublicFormContactInfo,
    publicFormSaving: publicSection.publicFormSaving,
    publicSettingsSaved: publicSection.publicSettingsSaved,
    savePublicFormSettings: publicSection.savePublicFormSettings,
    ...
    editingPublicSlotId: publicSection.editingPublicSlotId,
    editingPublicSlotDateStr: publicSection.editingPublicSlotDateStr,
    setEditingPublicSlotDateStr: publicSection.setEditingPublicSlotDateStr,
    editingPublicSlotTimeStr: publicSection.editingPublicSlotTimeStr,
    setEditingPublicSlotTimeStr: publicSection.setEditingPublicSlotTimeStr,
    publicSlotUpdating: publicSection.publicSlotUpdating,
    startEditPublicSlot: publicSection.startEditPublicSlot,
    cancelEditPublicSlot: publicSection.cancelEditPublicSlot,
    saveEditedPublicSlot: publicSection.saveEditedPublicSlot,
