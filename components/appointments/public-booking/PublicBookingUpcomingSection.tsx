  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2.5 px-1 pb-1">
        ...
        <h3 className="text-sm font-black text-warning-800">المواعيد القادمة</h3>
        {upcomingAppointments.length > 0 && (
          <span className="mr-auto text-[11px] font-black bg-warning-100 text-warning-700 rounded-full px-2.5 py-0.5 border border-warning-200">
    ...
    <div className="dh-patient-shell rounded-2xl border overflow-hidden">
      <div className="p-3 space-y-2 text-right" dir="rtl">
        ...
        <div className="flex items-center gap-2 pt-1">
          ...
          <button type="button" onClick={() => onRemove(apt.id)} className="p-1.5 rounded-xl border border-slate-200 text-slate-500 hover:bg-danger-50 hover:text-danger-600 hover:border-danger-200 transition-all" title="حذف">
