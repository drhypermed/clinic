...
export const SecretaryResponseToast: React.FC<SecretaryResponseToastProps> = ({
  ...
  <div className="fixed top-4 left-4 right-4 z-[9999] max-w-2xl mx-auto px-4 animate-fadeIn" aria-live="polite" dir="rtl">
    {toast.status === 'approved' ? (
      ...
      <div className="bg-white rounded-2xl shadow-xl border-2 border-emerald-400 p-4 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="font-bold text-emerald-700 text-sm">تم دخول الحالة</p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl border-2 border-amber-400 p-4 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-black text-slate-800 text-sm">رد السكرتارية</p>
          <p className="font-bold text-amber-700 text-sm">الحالة غير موجوده</p>
        </div>
