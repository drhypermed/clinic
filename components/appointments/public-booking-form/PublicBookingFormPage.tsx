 ...
 * - دعم خيار تسجيل الدخول بحساب Google قبل الحجز عندما يفعّله الطبيب.
...
export const PublicBookingFormPage: React.FC = () => {
  ...
  // المريض يملأ الفورم أولاً، وعند الضغط على الحجز يظهر طلب Google login
  // فقط لو الطبيب فعّل هذا الخيار من إعدادات الحجز.
