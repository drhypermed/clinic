          ...
          <div className="space-y-2">
            {branches.map((branch) => (
              <button
                ...
                className="w-full flex items-start justify-between gap-3 p-4 rounded-xl border-2 border-slate-200 bg-slate-50 hover:bg-amber-50 hover:border-amber-400 transition text-right"
              >
