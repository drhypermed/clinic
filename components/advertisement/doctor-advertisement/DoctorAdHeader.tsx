...
export const DoctorAdHeader: React.FC<DoctorAdHeaderProps> = ({
  ...
  return (
    <section className="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-3xl text-white p-6 shadow-xl">
