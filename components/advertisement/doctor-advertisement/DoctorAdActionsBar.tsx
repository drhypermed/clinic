    ...
    <div className="sticky bottom-4 z-20">
      <div className="bg-white/80 backdrop-blur-sm border border-slate-100 shadow-lg rounded-2xl p-3 flex flex-wrap gap-2 justify-end">
        ...
        <button
          ...
          disabled={saving}
          onClick={onPublish}
          className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-gradient-to-r from-success-600 to-success-700 text-white font-bold text-xs shadow-sm hover:shadow-md transition-all active:scale-[0.99] disabled:opacity-60"
        >
