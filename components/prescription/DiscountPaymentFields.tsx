  ...
  return (
    <div className="space-y-3 pt-3 mt-3 border-t border-slate-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            placeholder="0"
            className="w-full px-3 py-2.5 rounded-xl border-2 border-slate-200 focus:border-amber-400 focus:ring-2 focus:ring-amber-100 text-sm font-bold bg-white text-slate-800 text-center"
            dir="ltr"
          />
        </div>
        <div>
        ...
        <div>
          ...
          {discountReasons.length === 0 ? (
            ...
            <select
              ...
              className="w-full px-3 py-3 rounded-xl border-2 border-slate-200 focus:border-amber-400 focus:ring-2 focus:ring-amber-100 text-sm font-bold bg-white text-slate-800"
            >
          ...
          {resolvedReasonLabel && (
            <p className="mt-2 rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-xs font-black text-orange-800">
      ...
      <div className="bg-white/90 rounded-xl px-3 py-2.5 border border-slate-200 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        <span className="bg-amber-100 text-amber-700 px-2 py-1 rounded-lg font-black">
