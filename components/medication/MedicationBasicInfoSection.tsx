...
const fieldClass =
  'w-full px-3 py-2 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-success-500 focus:border-success-500 text-sm text-slate-800 transition-colors';
