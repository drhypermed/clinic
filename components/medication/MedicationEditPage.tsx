            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-sm p-3 flex flex-wrap items-center justify-between gap-2 dh-stagger-1">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-white font-black text-xs bg-gradient-to-r from-blue-600 to-blue-700 shadow-sm hover:shadow-md active:scale-[0.99] transition-all"
                    >
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-amber-200 bg-amber-50 text-xs font-bold text-amber-700 hover:bg-amber-100 transition-colors"
                    >
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="relative" ref={searchContainerRef}>
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-white border border-slate-200 rounded-xl pr-9 pl-9 py-2.5 font-medium text-slate-800 placeholder-slate-400 text-sm focus:ring-2 focus:ring-blue-100 focus:border-blue-400 outline-none transition-all"
                        />
                        {searchTerm && (
                            <button
                        ...
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden max-h-[60vh] overflow-y-auto z-[60] custom-scrollbar">
                            ...
                            {filteredMeds.map((med, idx) => (
                                <button
                                    ...
                                    className="w-full p-3 text-left hover:bg-sky-50 border-b border-slate-100 last:border-b-0 transition-colors group"
                                    dir="ltr"
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="hidden sm:flex w-9 h-9 rounded-xl bg-sky-100 text-sky-700 items-center justify-center shrink-0">
                                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="mt-1 flex items-center gap-2 text-[10px] font-bold">
                                                {(med as any).isNew ? (
                                                    <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">مضاف</span>
                                                ) : customizedIds.has(med.id) ? (
                                                    <span className="bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full">معدل</span>
                                                ) : null}
