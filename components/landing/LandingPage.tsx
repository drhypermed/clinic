...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    desc: 'فحص تفاعلات الأدوية بين كل أدويه الروشته، تصنيف أمان الأدوية في الحمل والرضاعه (FDA + LactMed + Briggs)، وحاسبه جرعات لمرضى الكلى.',
    color: 'from-danger-500 to-danger-600',
  },
  {
    icon: <FaWandMagicSparkles className="w-5 h-5 sm:w-6 sm:h-6" />,
    title: 'الروشتات الجاهزة',
    desc: 'احفظ روشته كامله بأدويتها وفحوصاتها وتعليماتها كقالب — وطبّقها على أي مريض جديد بضغطه. تقدر تعدّل أي جزء قبل الطباعه.',
    color: 'from-brand-500 to-brand-600',
  },
  {
  ...
  },
  {
    ...
    title: 'تنسيق صامت مع السكرتارية',
    desc: 'السكرتاريه بتسجّل المريض وقياساته (ضغط/سكّر/حراره/إلخ) قبل ما يدخل عليك، وبتضغط زر "دخول" لمّا يوصل — إنت بترد فوراً بـ"دخول" أو "انتظار" بدون ما حد يدخل عليك العياده.',
    color: 'from-warning-500 to-warning-600',
  },
  {
    icon: <HiOutlineClipboardDocumentList className="w-5 h-5 sm:w-6 sm:h-6" />,
    title: 'ملفات وسجلات المرضى',
    desc: 'كل مريض له ملف موحّد برقم ثابت بيجمع كل زياراته. بحث عميق بالاسم/التليفون/التشخيص/الشكوى/الدواء/رقم تأمين. ملاحظات طبيّه دائمه للمريض (حساسيات/أمراض مزمنه) تظهرلك كل زياره.',
  ...
  },
  {
    ...
    desc: 'إيرادات ومصروفات يوميه وشهريه وسنويه — بتتحدّث لحظياً مع كل كشف جديد. الشهور المنتهيه أرقامها بتتجمد كملخصات نهائيه. مطالبات تأمين، خصومات، صافي ربح.',
    color: 'from-brand-500 to-brand-600',
  },
  {
    icon: <HiOutlineCurrencyDollar className="w-5 h-5 sm:w-6 sm:h-6" />,
    title: 'فواتير وتأمينات احترافية',
    desc: 'إصدار فواتير A5 للمرضى برقم متسلسل لكل فرع. شركات تأمين بنسب تحمّل قابله للتخصيص لكل فرع، مع كشف تفصيلي بالحالات للشركه (إجمالي الفاتوره + تحمّل المريض + حصّه الشركه).',
  ...
  },
  {
    ...
    desc: 'صفحه عامه لعيادتك تظهر في جوجل (SEO جاهز) — بخدماتك وأسعارك وتقييمات المرضى ورابط الحجز المباشر. المريض بيلاقيك ويحجز عندك بدون تطبيق.',
    color: 'from-warning-500 to-warning-600',
  },
  {
