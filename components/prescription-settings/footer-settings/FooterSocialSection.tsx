    ...
    <>
            ...
            >
                <div className="space-y-4">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer p-2 bg-blue-50 rounded-lg border border-blue-100 w-fit">
                        <input
                            type="checkbox"
                        ...
                        />
                        <span className="font-bold text-blue-900">إظهار أيقونات السوشيال ميديا في الفوتر</span>
                    </label>
                    {footer.showSocialMedia && (
                        <div className="space-y-4">
                            {/* النص قبل الأيقونات */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-blue-800 block">النص قبل الأيقونات</label>
                            ...
                            {/* اسم الحساب */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-blue-800 block">اسم الحساب / الـ Handle</label>
                                <div className="border rounded-lg overflow-hidden shadow-sm">
                                    <RichTextEditor
                            ...
                            <div className="border-t border-blue-200 pt-4 space-y-4">
                                <h4 className="text-sm font-bold text-blue-900 mb-3">🎨 إعدادات الأيقونات</h4>
                                ...
                                <div className="p-3 bg-blue-50 rounded-lg border border-blue-200 space-y-3">
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="w-5 h-5 rounded accent-blue-600"
                                        />
                                        <label className="text-sm font-bold text-blue-800 cursor-pointer">Facebook</label>
                                    </div>
                                    {footer.showFacebookIcon !== false && (
                                        <div className="space-y-3 pl-7">
                                            <div className="grid grid-cols-2 gap-3">
                                                <div>
                                                    <label className="text-xs font-bold text-blue-700 mb-1 block">اللون</label>
                                                ...
                                                <div>
                                                    <label className="text-xs font-bold text-blue-700 mb-1 block">الحجم: {footer.facebookIconStyle?.size || 12}px</label>
                                                    <input
                                                        type="range"
                                                        min="6"
                                                        max="20"
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div>
                                                    <label className="text-xs font-bold text-blue-700 mb-1 block">إزاحة أفقية: {footer.facebookIconStyle?.xOffset || 0}px</label>
                                                    <input
                                                        type="range"
                                                        min="-10"
                                                        max="10"
                                                ...
                                                <div>
                                                    <label className="text-xs font-bold text-blue-700 mb-1 block">إزاحة رأسية: {footer.facebookIconStyle?.yOffset || 0}px</label>
                                                    <input
                                                        type="range"
                                                        min="-10"
                                                        max="10"
                                ...
                                <div className="p-3 bg-pink-50 rounded-lg border border-pink-200 space-y-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        />
                                        <label className="text-sm font-bold text-pink-800 cursor-pointer">Instagram</label>
                                    </div>
                                    {footer.showInstagramIcon !== false && (
                                        <div className="space-y-3 pl-7">
                                            <div className="grid grid-cols-2 gap-3">
                                                <div>
                                                    <label className="text-xs font-bold text-pink-700 mb-1 block">اللون</label>
                                                    <div className="flex gap-2 items-center">
                                                        <input
                                                            type="color"
                                                ...
                                                <div>
                                                    <label className="text-xs font-bold text-pink-700 mb-1 block">الحجم: {footer.instagramIconStyle?.size || 12}px</label>
                                                    <input
                                                        type="range"
                                                        min="6"
                                                        max="20"
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div>
                                                    <label className="text-xs font-bold text-pink-700 mb-1 block">إزاحة أفقية: {footer.instagramIconStyle?.xOffset || 0}px</label>
                                                    <input
                                                        type="range"
                                                        min="-10"
                                                        max="10"
                                                ...
                                                <div>
                                                    <label className="text-xs font-bold text-pink-700 mb-1 block">إزاحة رأسية: {footer.instagramIconStyle?.yOffset || 0}px</label>
                                                    <input
                                                        type="range"
                                                        min="-10"
                                                        max="10"
                                ...
                                <div className="p-3 bg-red-50 rounded-lg border border-red-200 space-y-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        />
                                        <label className="text-sm font-bold text-red-800 cursor-pointer">YouTube</label>
                                    </div>
                                    {footer.showYouTubeIcon !== false && (
                                        <div className="space-y-3 pl-7">
                                            <div className="grid grid-cols-2 gap-3">
                                                <div>
                                                    <label className="text-xs font-bold text-red-700 mb-1 block">اللون</label>
                                                    <div className="flex gap-2 items-center">
                                                        <input
                                                            type="color"
                                                ...
                                                <div>
                                                    <label className="text-xs font-bold text-red-700 mb-1 block">الحجم: {footer.youtubeIconStyle?.size || 12}px</label>
                                                    <input
                                                        type="range"
                                                        min="6"
                                                        max="20"
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div>
                                                    <label className="text-xs font-bold text-red-700 mb-1 block">إزاحة أفقية: {footer.youtubeIconStyle?.xOffset || 0}px</label>
                                                    <input
                                                        type="range"
                                                        min="-10"
                                                        max="10"
                                                ...
                                                <div>
                                                    <label className="text-xs font-bold text-red-700 mb-1 block">إزاحة رأسية: {footer.youtubeIconStyle?.yOffset || 0}px</label>
                                                    <input
                                                        type="range"
                                                        min="-10"
                                                        max="10"
