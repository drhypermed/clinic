                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {middle.middleBgColor && middle.middleBgColor !== '#ffffff' && (
                                    <button
                                        ...
                                        className="px-3 py-2 bg-danger-100 text-danger-700 rounded-lg hover:bg-danger-200 transition-all text-sm font-bold"
                                        title="إزالة اللون"
                                    >
                                        ✖
                                    </button>
                    ...
                    <div className="border-t border-slate-200 my-4 pt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full accent-success-600 h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer"
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full accent-warning-600 h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer"
                            />
                        </div>
                    </div>
                )}
