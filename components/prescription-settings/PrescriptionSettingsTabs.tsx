...
const TABS: TabConfig[] = [
    ...
    },
    {
        ...
        activeShadow: 'shadow-success-200',
    },
    {
        id: 'vitals',
        label: 'الجزء الجانبي',
        shortLabel: 'الجانبي',
        icon: <VitalsIcon />,
        gradient: 'from-danger-500 to-slate-600',
        activeShadow: 'shadow-danger-200',
    },
    {
        id: 'middle',
        label: 'منتصف الروشتة',
    ...
    },
    {
        ...
        activeShadow: 'shadow-warning-200',
    },
];
